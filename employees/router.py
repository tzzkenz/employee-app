...
async def patch_employee(id: int, body: EmployeePatch, db: AsyncSession = Depends(get_db)):
  employee = await service.patch_employee(id, body, db)
  return employee
